...
# R stats meme
url <- "https://pbs.twimg.com/media/EgXRjSgWoAQqWrh.jpg"
...
## <span style="color:red">**Coding Check #1:**</span>

Your first lab assignment is to get you a bit more familiar with R. **This will be due September 5th by 11:59 PM**. You will submit both your R markdown code and the Word output of your work. This assignment can be completed with other members from your lab section but if you work with others, please include their names on your submission.   
...
4.  **Find a recent ecology publication with figures created in R** Figures created in R are often very distinctive and common across the field of ecology today! Your last part of your coding check is to search through recently published primary research articles (published in 2020 or more recent) that has used R to analyze and visualize the data reported. From this paper, specifically identify one figure with the corresponding analysis and provide a brief summary of both the figure and statistical analysis (see Canvas for an example).
...
* [The Pirate's Guide to R (online text book)](https://bookdown.org/ndphillips/YaRrr/)
* [R for Data Science (online text book)](https://r4ds.hadley.nz/)
...
* [YouTube video of Ecology in R tutorial](https://www.youtube.com/watch?v=dQe3Z7hRG1s)
